...
IF Force_Flag = 1
	...
	!	WAIT Detect_Time
		...
		TILL GMQU(2) = 1 & GPHASE(2) = 4; 
		WAIT 10			 ! Motion Queue & Constant Velocity
		TILL 0.05 < ABS(getsp(1,getspa(1,"axes[0].command"))), 20 * 1000!Force Mode Current Limit
		
		IF(0.05 >= ABS(getsp(1,getspa(1,"axes[0].command"))))
			nFail = 1 
			DISP "KILL 2"; 
			!PTP/ER 2, -0.1
			PTP/f 2, 0, 5
