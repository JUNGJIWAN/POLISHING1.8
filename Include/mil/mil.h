...
/* MIL DIRECTX SERVICE                                                  */
/************************************************************************/
#if M_MIL_USE_WINDOWS && !M_MIL_USE_CE && !M_MIL_USE_RT && !M_MIL_USE_IOT
...
#define M_PROC_CURRENT_VERSION   M_PROC_VERSION_100_PP2
...
/* Reserve next 448 values                     from   5120L*/
/*                                             to     5504L*/
...
#define M_IS_IN_CPU_FLAG_RANGE(n)                     ((((n) & ~(M_CLIENT_ASCII_MODE | M_STRING_SIZE)) >= M_CPU_FLAG_RANGE) && \
                                                       (((n) & ~(M_CLIENT_ASCII_MODE | M_STRING_SIZE)) <= M_CPU_FLAG_RANGE_END))
...
#define M_DIG_INQUIRE_STRING_START                    7700L
      ...
      #define M_GC_FEATURE_BROWSER_NODES                       (7709L|M_CLIENT_ASCII_MODE)
      ...
      #define M_GC_FEATURE_BROWSER_NODES                       7709L
...
#define M_TIMER_TRIGGER_OVERLAP                       0x20708L
      ...
      /* Reserve next 100 values                     from   0x2076CL*/
...
/* Free for future board type                        260L*/
...
#define M_BAYER_MASK                                  480L // M_BAYER_GB | M_BAYER_BG | M_BAYER_RG | M_BAYER_GR
...
#if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL) 
#define M_NAME                                        (0x00200000L | M_CLIENT_ASCII_MODE)
#else
...
#define M_MODIFIED_REGION                                     25L
#define M_FEATURE_CHANGE                                      26L
#define M_WEB_CLIENT_CONNECTED                                27L       // app hook
#define M_WEB_CLIENT_DISCONNECTED                             28L       // app hook
#define M_WEB_CONNECTION_LOST                                 29L       // app hook
...
#define M_OBJECT_PUBLISH_WEB                                  34L       // app hook
...
#define M_OBJ_HOOK_USER_RANGE_START                   0x000000900L
#define M_OBJ_HOOK_USER_RANGE_END                     0x0000009FFL
#define M_MODIFIED_BUFFER                             0x40000000L
#define M_UNHOOK                                      0x04000000L
#define M_ASYNC_HOOK                                  0x08000000L
#define M_GRAB_LINE                                   0x00100000L
...
#define M_WEB_CLIENT_CONNECTED                       27L
#define M_WEB_CLIENT_DISCONNECTED                    28L
#define M_WEB_CONNECTION_LOST                        29L
...
#define M_DIRECT_ACCESS_START                         (M_APP_INQUIRE_SYS_START+832L)
   ...
   /* The next values are available from              (M_APP_INQUIRE_SYS_START+964L)*/
...
#define M_REG_DEF_BUFFER_TYPE                   (M_APP_INQUIRE_SYS_START+10050L)
/* Reserve values from                          (M_APP_INQUIRE_SYS_START+10051L)*/
/*                to                            (M_APP_INQUIRE_SYS_START+10113L)*/
...
#define M_APP_INQUIRE_OBJ_STRING_START                M_FUNC_INQUIRE_STRING_START // 47
      ...
      #define M_OBJECT_FILENAME                       ((M_FUNC_INQUIRE_STRING_START+1)|M_CLIENT_ASCII_MODE) //47
   #else
      #define M_ASSOCIATED_NAME                       (M_FUNC_INQUIRE_STRING_START+0)
      #define M_OBJECT_FILENAME                       (M_FUNC_INQUIRE_STRING_START+1)
   #endif
...
// #define unused                                     M_OBJ_HOOK_RANGE_START+12L
...
#define M_IN_DIG_GET_HOOK_INFO_STRING_RANGE(X)           (((X&(~M_CLIENT_ASCII_MODE)) == (M_GC_FEATURE_CHANGE_NAME&(~M_CLIENT_ASCII_MODE)) ) || \
                                                           ((X&(~M_CLIENT_ASCII_MODE)) == (M_CAMERA_MODEL&(~M_CLIENT_ASCII_MODE)) ) )
