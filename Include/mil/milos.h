...
#if defined(M_MIL_DEBUG) || defined(_DEBUG)
...
/* Safe type is activated by default in C++ and in Debug.
   It is deactivated in Release or in C. */
      ...
      #if (!defined(_MSC_VER) || (_MSC_VER >= 1600)) /* When the type std::nullptr_t exists. */
            #define M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS 1
      #endif
   #endif
#endif
